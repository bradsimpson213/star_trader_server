...
def upgrade():
     ...
     op.bulk_insert(users_table, 
          [
          {'name': 'Luke Skywalker', 'email': 'lukeskywalker@aol.com', 'hashed_password': generate_password_hash('force1'), 'species': 1, 'bio': 'Luke Skywalker was a Tatooine farmboy who rose from humble beginnings to become one of the greatest Jedi the galaxy has ever known.',
          ...
          {'name': 'Darth Maul', 'email': 'darthmaul@jediturnedsith.org', 'hashed_password': generate_password_hash('jediscum'), 'bio': "A deadly, agile Sith Lord trained by the evil Darth Sidious, Darth Maul was a formidable warrior and scheming mastermind. He wielded an intimidating double-bladed lightsaber and fought with a menacing ferocity. ",
               'faction': False, 'user_image': 'https://starwars-trader-imgs.s3.us-east-2.amazonaws.com/img/characters/17.jpg', 'Force_points': 0},
